      ...
      <div className="container section-spacing">
        <div className="row">
          ...
          <div id="service1" className="col-md-6">
            ...
            <p>
              Does your organization have internal processes that software could
              automate? Maybe a web-based or mobile application is the core of
              your company?
              <br />
              <br />
          ...
          <div id="service2" className="col-md-6">
            ...
            <p>
              ...
              not have taken the time to really understand who your customer is
              and what your company’s purpose is.{' '}
              <em>
            ...
            <p>
              ...
              accomplish your business goals? Or maybe you need help coming up
              with that crazy idea? Sounds like our kind of crazy.
              <br />
              <br />
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-12 text-center">
            ...
            <img src="./assets/img/logo-images/logo-estate-assist.png" alt="" />{' '}
        ...
        <div className="row">
          <div className="col-sm-8 col-sm-offset-2" id="testimonial">
            <p>
              ...
              that makes them a delight to work with. Even working remotely,
              They are fantastic collaborators, sharing in idea generation,
