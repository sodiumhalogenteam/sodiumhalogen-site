...
class WebflowComponentTestPage extends React.Component {
  render() {
      ...
      <div>
        <Layout>
          ...
          <section class="w-container w600">
            <h2>
              Without a clear destination and plan for getting there, how will
              you know when you’ve arrived?
            </h2>
            <p>
              If you were taking your family on a trip, you wouldn’t pile in
              your car, pull on the road and then try to determine your
              destination. But smart companies like yours do that everyday.
            </p>
            <p>
              They start business projects by loading their team into a
              conference room, and deciding a general direction as vague as “go
              west!” But they haven’t determined a firm destination, the route
              they’ll take, or if they have enough fuel to arrive. Most
              importantly...they haven’t asked why they want to go.
            </p>
          ...
          <section class="container card-section">
            ...
            <p className="w800">
              When we do a Strategy Workshop in-person, we pull from over a
              dozen different interactive exercises. Now we are making each of
              these exercises available to you. Each course comes with a video
              to walk you through the exercise and PDF worksheet.
            </p>
            <Grid>
              <Card
                title="Audience"
